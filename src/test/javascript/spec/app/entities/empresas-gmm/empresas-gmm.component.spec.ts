...
import { EmpresasGmmComponent } from 'app/entities/empresas-gmm/empresas-gmm.component';
...
describe('Component Tests', () => {
  describe('EmpresasGmm Management Component', () => {
    let comp: EmpresasGmmComponent;
    let fixture: ComponentFixture<EmpresasGmmComponent>;
    let service: EmpresasGmmService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [JhipsterOrclTestModule],
        declarations: [EmpresasGmmComponent],
        providers: [
          {
        ...
        .overrideTemplate(EmpresasGmmComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(EmpresasGmmComponent);
